...
{
    DRR, PF, MAXCI, MAXCI_MB, MAXCI_OPT_MB, MAXCI_COMP, ALLOCATOR_BESTFIT, NAIVE_ROUND_ROBIN, NAIVE_ROUND_ROBIN_REUSE, REUSE_TESTER, TU_GAME, TU_GAME_RANDOMREUSE, STACKELBERG_GAME, MODDED_STACKELBERG_GAME, PROPFAIR, UNKNOWN_DISCIPLINE
};
...
const SchedDisciplineTable disciplines[] = {
	...
	ELEM(NAIVE_ROUND_ROBIN),
	ELEM(NAIVE_ROUND_ROBIN_REUSE),
	ELEM(REUSE_TESTER),
	ELEM(TU_GAME),
	ELEM(TU_GAME_RANDOMREUSE),
	ELEM(STACKELBERG_GAME),
	ELEM(MODDED_STACKELBERG_GAME),
	ELEM(PROPFAIR),
