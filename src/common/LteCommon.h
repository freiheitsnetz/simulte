...
{
    DRR, PF, MAXCI, MAXCI_MB, MAXCI_OPT_MB, MAXCI_COMP, ALLOCATOR_BESTFIT, NAIVE_ROUND_ROBIN, NAIVE_ROUND_ROBIN_REUSE, REUSE_TESTER, TU_GAME, STACKELBERG_GAME, UNKNOWN_DISCIPLINE
};
