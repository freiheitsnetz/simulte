...
#ifndef _LTE_LTERLCUMREALISTICAUTOD2D_H_
#define _LTE_LTERLCUMREALISTICAUTOD2D_H_
...
/**
 * @class LteRlcUmRealisticAutoD2D
 * @brief UM Module
 *
 * This is the UM Module of RLC (with support for AutoD2D)
...
class LteRlcUmRealisticAutoD2D: public LteRlcUm {
public:
    LteRlcUmRealisticAutoD2D() {
    }
    virtual ~LteRlcUmRealisticAutoD2D() {
    }
