...
#ifndef _LTE_LTE_SCHEDULER_AUTOD2D_UL_H_
#define _LTE_LTE_SCHEDULER_AUTOD2D_UL_H_
 ...
 *
 * LTE UeAutoD2D uplink scheduler.
 */
class LteSchedulerUeAutoD2DUl : public LteSchedulerUeAutoD2D
{
  protected:
...
//    friend class LteMacUeAutoD2DRealistic;
  ...
  public:
    ...
    /**
     * signals RAC request to the scheduler (called by UeAutoD2D)
     */
...
#endif // _LTE_LTE_SCHEDULER_UEAUTOD2D_UL_H_
