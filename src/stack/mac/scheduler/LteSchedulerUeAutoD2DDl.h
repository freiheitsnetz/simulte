...
#ifndef _LTE_LTE_SCHEDULER_UEAUTOD2D_DL_H_
#define _LTE_LTE_SCHEDULER_UEAUTOD2D_DL_H_
 ...
 *
 * LTE UeAutoD2D downlink scheduler.
 */
class LteSchedulerUeAutoD2DDl : public LteSchedulerUeAutoD2D
{
...
#endif // _LTE_LTE_SCHEDULER_UEAUTOD2D_DL_H_
