...
#ifndef _LTE_LTESCHEDULERUEAUTOD2DDLREALISTIC_H_
#define _LTE_LTESCHEDULERUEAUTOD2DDLREALISTIC_H_
...
class LteSchedulerUeAutoD2DDlRealistic : public LteSchedulerUeAutoD2DDl
{

public:
    LteSchedulerUeAutoD2DDlRealistic();
    virtual ~LteSchedulerUeAutoD2DDlRealistic();
...
#endif /* _LTE_LTESCHEDULERAUTOD2DDLREALISTIC_H_ */
