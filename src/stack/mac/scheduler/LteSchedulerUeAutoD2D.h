...
#ifndef _LTE_LTESCHEDULERUEAUTOD2D_H
#define _LTE_LTESCHEDULERUEAUTOD2D_H
...
//    friend class LteMaxCiComp;
    friend class LteMaxCiAutoD2D;
    friend class LteMacUeAutoD2D;
    friend class LteMacUeAutoD2DRealistic;
    friend class LteSchedulerAutoD2D;
  ...
  protected:
    ...
    // Scheduling agent.
    LteSchedulerAutoD2D *scheduler_;
  ...
  public:
     ...
     */
    void initialize(Direction dir, LteMacUeAutoD2D* mac);
  ...
  protected:
     ...
     * LteSchedulerUeAutoD2D: these are common functions used inside the schedule method, which is
  ...
  private:
     ...
     */
    LteSchedulerAutoD2D* getScheduler(SchedDiscipline discipline);
};

#endif // _LTE_LTESCHEDULERUEAUTOD2D_H
