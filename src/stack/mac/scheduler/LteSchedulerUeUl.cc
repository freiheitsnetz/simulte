...
LteSchedulerUeUl::LteSchedulerUeUl(LteMacUe * mac)
{
    ...
    if (macType.compare("LteMacUeRealistic") == 0 || macType.compare("LteMacUeRealisticD2D") == 0 || macType.compare("LteMacUeAutoD2D") == 0)
        lcgScheduler_ = new LcgSchedulerRealistic(mac);
    else if (macType.compare("LteMacUeAutoD2D") == 1)
