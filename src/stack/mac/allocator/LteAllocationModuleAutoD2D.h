...
#ifndef _LTE_LTEALLOCATIONMODULEAUTOD2D_H_
#define _LTE_LTEALLOCATIONMODULEAUTOD2D_H_

#include "LteCommon.h"
#include "LteMacUeAutoD2D.h"
//class LteMacUeAutoD2D;
class LteMacUeAutoD2DRealistic;
...
class LteAllocationModuleAutoD2D
{
  ...
  public:
    ...
    /// Default constructor.
    LteAllocationModuleAutoD2D(LteMacUeAutoD2D *mac, const Direction direction);
