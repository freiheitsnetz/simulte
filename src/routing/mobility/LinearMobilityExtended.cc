...
Define_Module(LinearMobilityExtended);

LinearMobilityExtended::LinearMobilityExtended()
{
    speed = 0;
    angle = 0;
    acceleration = 0;
...
void LinearMobilityExtended::initialize(int stage)
{
...
void LinearMobilityExtended::move()
{
